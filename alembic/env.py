...
# Importa a Base do nosso modelo principal para que o Alembic saiba quais tabelas criar
...
# Adiciona nosso modelo (Base) ao target_metadata
...
def run_migrations_online() -> None:
    ...
    """
    # Usa a variável de ambiente DATABASE_URL que configuramos no Render
